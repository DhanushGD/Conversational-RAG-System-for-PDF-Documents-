...
if api_key:
    ...
    # Split and create embeddings for the documents
        ...
        # Initialize Chroma vector store with correct settings
        client_settings = {
            "tenant": "default_tenant",  # Ensure this tenant exists or modify it
            "database": "pdf_documents"  # Unique name for your database
        }
